        ...
        <div className="animate-fade-up">
          ...
          <div className="mt-12 grid grid-cols-3 gap-6 max-w-lg">
            {[
              ...
              { k: "1.42M", v: "Hectares Mapped" },
              { k: "+24%", v: "Avg. Yield Lift" },
            ].map((s) => (
              <div key={s.v}>
    ...
    <div className="relative">
      <div className="glass rounded-2xl p-6 shadow-elevated animate-float">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="h-12 w-12 rounded-xl bg-gradient-primary flex items-center justify-center text-primary-foreground font-display font-bold">
            KE
          </div>
        </div>
        ...
        <div className="mt-5 pt-4 border-t border-border flex items-center justify-between text-xs">
          <span className="text-muted-foreground">Njoro Plot · Nakuru</span>
